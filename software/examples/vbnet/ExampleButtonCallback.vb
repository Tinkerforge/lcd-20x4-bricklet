...
Module ExampleButtonCallback
    ...
    Sub ButtonPressedCB(ByVal sender As BrickletLCD20x4, ByVal buttonPressed As Byte)
        System.Console.WriteLine("Button Pressed: " + buttonPressed.ToString())
    End Sub

    ' Callback function for button released callback
    Sub ButtonReleasedCB(ByVal sender As BrickletLCD20x4, ByVal buttonReleased As Byte)
